	...
	def __init__(self,command):
		...
		if sys.platform != "win32":
			if pachi_working_directory:
				...
				self.process=subprocess.Popen(command,cwd=pachi_working_directory, stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE, universal_newlines=True)
			else:
