...
for (chassis, file, ids) in (("eagle", "eagle/eagle.3do", Set([29108, 39200])), ("brm", "brm/brm.3do", Set([26116, 35320])))
...
pass(occursin("AI_PARKED_SUSP_GROUPS = Dict(\"eagle\" => Set([29108, 39200]), \"brm\" => Set([26116, 35320]))", SRC), "loader carries the per-chassis map", "source check")
