...
# CROSS-VALIDATED on the Nürburgring Nordschleife (fit_nurburgring.jl): this
# skidpad curve predicts Nordschleife lateral accel at R²=0.86 on 23k independent
# samples — the grip generalises.  Longitudinal pKx1=16.6 from braking (κ to −1);
# μx≈μy confirmed (friction isotropy).  NOT changed by Nordschleife: μy (the
# higher road-course g is banking/compression, not grip) and pKy2 (load
# sensitivity not identifiable from forward-ay — needs the per-corner model).
...
const TYRE_SKIDPAD_FRONT = (
    ...
    Ey = 0.40, Ex = -0.5, pKy1 = 25.7, pKy2 = 2.2, pKx1 = 16.6, t0 = 0.035, Bt = 8.0)
const TYRE_SKIDPAD_REAR = (
    Fz0 = 1670.0, μy = 1.304, μx = 1.304, Cy = 1.000, Cx = 1.6,
    Ey = 0.329, Ex = -0.5, pKy1 = 33.8, pKy2 = 2.2, pKx1 = 16.6, t0 = 0.035, Bt = 8.0)
