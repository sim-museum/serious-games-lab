...
| E74 | **Cockpit** (the "Dali dials") | 4 (S1–S4) | ✅ **D1 badge FIXED** (U+V flip, render.jl:1059); D2 gauges washed out — S3: brightness REFUTED as cause (3 arms); S4: minification test FAILED to isolate (scaling displaces the dials) — but revealed the cluster sits up-and-LEFT of gold's, partly clipped; next = sweep JM_GAUGE_X; D3 wheel oversized; D4 FOV — see e74_cockpit.md |
