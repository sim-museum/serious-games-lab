...
| E75 | **Exterior Lotus 49** (missing axles) | 6 (S1–S6) | D1 RESTATED (S2): suspension DOES draw (3250 px toggle) but is occluded — S3: that was REFUTED — wheels 0.74 vs hub line 0.772 agree to 3 cm; S4: NO fold angle works (0 deg = spears, 45/90 = invisible) — JM is rehabilitating GPL's runtime-HIDDEN branch; S5: parts NAMED (lshok/lsusp5/lsusp7/lbrdisc/frontlot, all present in the .3do, none excluded by name); maxlat REFUTED as the cause; S6: ⭐ FRONT suspension drawn NOWHERE — FSUSPP asks for lsusp1 while excluding every group containing it (all 36 tris in 6600/3560); REAR is in 27288/39792 and is the fold problem; D2 track wide (already tuned, do not re-tune); D3 exhausts splayed; grey tyres = known asset gap — see e75_exterior.md |
