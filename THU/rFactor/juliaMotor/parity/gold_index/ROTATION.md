...
| E75 | **Exterior Lotus 49** (missing axles) | 4 (S1–S4) | D1 RESTATED (S2): suspension DOES draw (3250 px toggle) but is occluded — S3: that was REFUTED — wheels 0.74 vs hub line 0.772 agree to 3 cm; S4: NO fold angle works (0 deg = spears, 45/90 = invisible) — JM is rehabilitating GPL's runtime-HIDDEN branch; gold's linkage must be other geometry, so find which exclusion eats it; D2 track wide (already tuned, do not re-tune); D3 exhausts splayed; grey tyres = known asset gap — see e75_exterior.md |
