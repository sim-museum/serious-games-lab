...
| E75 | **Exterior Lotus 49** (missing axles) | 2 (S1–S2) | D1 RESTATED (S2): suspension DOES draw (3250 px toggle) but is occluded — wheels placed ~18% too wide for the body mesh; D2 track wide (already tuned, do not re-tune); D3 exhausts splayed; grey tyres = known asset gap — see e75_exterior.md |
