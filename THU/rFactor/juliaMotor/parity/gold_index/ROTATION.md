...
| E75 | **Exterior Lotus 49** (missing axles) | 3 (S1–S3) | D1 RESTATED (S2): suspension DOES draw (3250 px toggle) but is occluded — S3: that was REFUTED — wheels 0.74 vs hub line 0.772 agree to 3 cm; real issue is rsfix folding the linkage ONTO the hub where the tyre hides it; D2 track wide (already tuned, do not re-tune); D3 exhausts splayed; grey tyres = known asset gap — see e75_exterior.md |
