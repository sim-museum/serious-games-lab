...
| E70 | **Nürburgring** | 4 (S1–S4) | STRUCTURAL: Ring scenery is track-mesh, not instances — E71 censuses produce NOTHING here; S2: censuses were UNREACHABLE here (inside the GPL objects block) — relocated so they run on every track; first real measurement: centreline CLEAN 46/46 over 22.7 km — see e70_nurburgring.md |
