...
| E69 | **Zandvoort** | 3 (S1–S3) | S2 CORRECTION: on-track crowds ARE reproduced — ppl_m1 @3851 and ppl_l3 @3256 reach 0.2/0.8 m from the centreline from origins 5.5/12.3 m out (S1 used the origin-based census); + bushes at 2309–2405. S3: ppl_l3 renders as a WALL across the left (billboard drawn flat); ⭐ s=3851 main straight is EMPTY where gold has grandstands+pits+Dunlop bridge+crowds — the E76 defect on a SECOND track; sky grade CORRECT; kerbs/crowd-density/road-tone candidates — see e69_zandvoort.md |
