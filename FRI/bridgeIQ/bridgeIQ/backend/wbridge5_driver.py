...
handle:
  ...
  Server → client:
    "<seat> ("<name>") seated"
    "Teams: N/S : "bridgeIQ". E/W : "bridgeIQ"."
    "Start of board"
...
# Map bridgeIQ enum identities to TM-protocol string tokens.
...
class TMServer:
    ...
    def play_auction(self, conns: Dict[Seat, TMConnection],
        ...
        Bid to play. Used by the diff harness to let bridgeIQ's
        ...
        for _ in range(max_iters):
            ...
            # supply the bid via the callback (using bridgeIQ's
            # bidder by default).
