...
# learn cockpit instruments, practice takeoff and landing in a P-51D Mustang
...
fgfs --start-date-sys=2020:06:01:12:00:00 --aircraft=p51d-jsbsim --fg-aircraft=$FGADDON_DIR/Aircraft --in-air --altitude=10000 --vc=200 --enable-freeze 2>/dev/null 1>/dev/null
