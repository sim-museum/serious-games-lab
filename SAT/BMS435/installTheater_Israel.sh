...
mv "$WINEPREFIX/../../downloads/Israel_Theater_4.35.3.zip" $WINEPREFIX/../INSTALL 2>/dev/null 1>/dev/null
mv "$WINEPREFIX/../../downloads/Israel Theater 1.05.4v Patch.zip" $WINEPREFIX/../INSTALL 2>/dev/null 1>/dev/null
