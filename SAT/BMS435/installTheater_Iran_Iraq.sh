...
mv "$DOWNLOADS_DIR/Add-On Mideast128 4-35-U3v10.zip" $INSTALL_DIR 2>/dev/null 1>/dev/null

if [ ! -f "$INSTALL_DIR/Add-On Mideast128 4-35-U3v10.zip" ]
then
	printf "Iran-Iraq theater file not found in $INSTALL_DIR.\nFrom the theaters section of www.falcon-bms.com,\nDownload the latest BMS 4.35.3 Mideast theater file:\nAdd-On Mideast128 4-35-U3v10.zip\nPlace this file in the $INSTALL_DIR directory,\n\nthen run this script again.\n\n"
	exit 0
fi
...
cp -R "$INSTALL_DIR/Add-On Mideast128" "$WINEPREFIX/drive_c/Falcon BMS 4.35/Data"
