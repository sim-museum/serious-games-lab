...
struct IDirect3DDevice7 {
    ...
    HRESULT EnumTextureFormats(void *lpd3dEnumPixelProc, LPVOID lpArg) { return lpVtbl->EnumTextureFormats(this, lpd3dEnumPixelProc, lpArg); }
...
/* D3D creation - OpenGL backend factory functions */
#ifdef __cplusplus
extern "C" {
#endif

/* Create Direct3D7 interface (OpenGL-backed) */
IDirect3D7* FF_CreateDirect3D7(void);

/* Create Direct3DDevice7 (OpenGL-backed) */
IDirect3DDevice7* FF_CreateDirect3DDevice7(IDirect3D7* d3d, IDirectDrawSurface7* renderTarget);

/* Create DirectDraw7 interface (minimal stub) */
...
/* Forward declaration for DXContext */
struct DXContext;
...
/* Legacy macros - redirect to factory functions for compatibility */
