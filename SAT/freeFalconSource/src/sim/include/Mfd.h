...
public:
    ...
    MfdMode GetSP(int n)
    {
        return primarySecondary[curmm][n];
    };
    MfdMode CurMode()
    {
        return mode == MfdMenu ? restoreMode : mode;
    };
    ...
    DrawableClass *GetDrawable() const
    {
        return const_cast<DrawableClass*>(drawable);
    }
    void SetDrawable(DrawableClass *newDisplay)
    {
        drawable = newDisplay;
    }
    ...
    void SetTGPWarning(int warning)
    {
        TGPWarning = warning;
    }
...
public:
    ...
    virtual void Display(VirtualDisplay*vd)
    {
        display = vd;
    };
...
public:
    ...
    virtual void PushButton(int, int);
    void SetCurMode(MFDClass::MfdMode cm)
    {
        curmode = cm;
    };
