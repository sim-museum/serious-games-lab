    ...
    if ( not g_bRealisticAvionics or (g_bRealisticAvionics and active))
    {
        ...
        for (i = 0; i < mDestDigits; i++)
        {
            if (mpSourceBuffer[mpValues[i]].m_arrTex.size() == 1)
            {
                ...
                pVtx[0].x = (float)mpDestRects[i].left;
                pVtx[0].y = (float)mpDestRects[i].top;
                pVtx[0].u = fStartU;
                pVtx[0].v = fStartV;
                pVtx[0].r = pVtx[0].g = pVtx[0].b = pVtx[0].a = 1.0f;
                pVtx[1].x = (float)mpDestRects[i].right;
                pVtx[1].y = (float)mpDestRects[i].top;
                pVtx[1].u = fMaxU;
                pVtx[1].v = fStartV;
                pVtx[1].r = pVtx[1].g = pVtx[1].b = pVtx[1].a = 1.0f;
                pVtx[2].x = (float)mpDestRects[i].right;
                pVtx[2].y = (float)mpDestRects[i].bottom;
                pVtx[2].u = fMaxU;
                pVtx[2].v = fMaxV;
                pVtx[2].r = pVtx[2].g = pVtx[2].b = pVtx[2].a = 1.0f;
                pVtx[3].x = (float)mpDestRects[i].left;
                pVtx[3].y = (float)mpDestRects[i].bottom;
                pVtx[3].u = fStartU;
                pVtx[3].v = fMaxV;
