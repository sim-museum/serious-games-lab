...
public:
    ...
    static void Cleanup();
    static StarData *GetStarData()
    {
        return CurrentStarData;
    };
    ...
    static void SetSunPosition(float az, float alt)
    {
        SunAz = az;
        SunAlt = alt;
    };
    static void SetMoonPosition(float az, float alt)
    {
        MoonAz = az;
        MoonAlt = alt;
    };
    static void GetSunPosition(float *az, float *alt)
    {
        *az = SunAz;
        *alt = SunAlt;
    };
    static void GetMoonPosition(float *az, float *alt)
    {
        *az = MoonAz;
        *alt = MoonAlt;
    };
