...
public:
    ...
    {
        return ParentObject->radius;
    };
    float BoxLeft(void) const
    {
        return ParentObject->minY;
    };
    float BoxRight(void) const
    {
        return ParentObject->maxY;
    };
    float BoxTop(void) const
    {
        return ParentObject->minZ;
    };
    float BoxBottom(void) const
    {
        return ParentObject->maxZ;
    };
    float BoxFront(void) const
    {
        return ParentObject->maxX;
    };
    float BoxBack(void) const
    {
        return ParentObject->minX;
    };
    float RadarSign(void)
    {
        return RadarSignal;
    };
    ...
    int GetNTextureSet()
    {
        return ParentObject->nTextureSets;
    };
