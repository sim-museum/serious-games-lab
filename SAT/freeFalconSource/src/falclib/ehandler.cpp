...
// Linux stub - exception handling is done differently on Linux
#include "compat/compat_types.h"
#include "include/ehandler.h"
#include <stdio.h>
...
int __cdecl RecordExceptionInfo(PEXCEPTION_POINTERS data, const char *Message)
{
    // On Linux, we don't use Windows SEH. Signal handlers are used instead.
    fprintf(stderr, "[CRASH] Exception in %s\n", Message ? Message : "unknown");
    return 0; // EXCEPTION_CONTINUE_SEARCH equivalent
}
