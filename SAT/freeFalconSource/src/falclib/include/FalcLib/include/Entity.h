...
struct UnitClassDataType
{
    ...
    int Fuel; // use int for 32/64-bit portability // Fuel (internal)
...
struct VehicleClassDataType
{
    ...
    int MaxWt; // use int for 32/64-bit portability // Max loaded weight in lbs.
    int EmptyWt; // use int for 32/64-bit portability // Empty weight in lbs.
    int FuelWt; // use int for 32/64-bit portability // Weight of max fuel in lbs.
