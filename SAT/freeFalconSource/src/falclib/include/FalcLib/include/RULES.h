...
public:
    ...
    int BlackoutOn(void)
    {
        return !(SimFlags & SIM_NO_BLACKOUT);
    }
    int NoBlackout(void)
    {
    ...
    {
        return !(SimFlags & SIM_NO_COLLISIONS);
    }
    ...
    void SetObjMagnification(float mag)
    {
    ...
    void SetSimWeaponEffect(WeaponEffectType WE)
    {
        SimWeaponEffect = WE;
    };
    void SetSimAvionicsType(AvionicsType AT)
    {
        SimAvionicsType = AT;
    };
    void SetSimAutopilotType(AutopilotModeType AM)
    {
        SimAutopilotType = AM;
    };
    void SetRefuelingMode(RefuelModeType RM)
    {
        SimAirRefuelingMode = RM;
    };
    void SetPadlockMode(PadlockModeType PM)
    {
        SimPadlockMode = PM;
    };
};
