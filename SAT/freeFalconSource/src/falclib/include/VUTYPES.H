...
typedef uint32_t VU_KEY;           // FF_LINUX: Use uint32_t for 32-bit Windows binary compat
typedef uint32_t VU_ID_NUMBER;     // FF_LINUX: Use uint32_t for 32-bit Windows binary compat
