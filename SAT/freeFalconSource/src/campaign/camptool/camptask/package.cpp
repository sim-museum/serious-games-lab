...
PackageClass::PackageClass(VU_BYTE **stream) : AirUnitClass(stream)
{
    ...
    memset(element, 0, sizeof(VU_ID)*MAX_UNIT_CHILDREN);
    memcpy(&elements, *stream, sizeof(uchar));
    *stream += sizeof(uchar);
    memcpy(element, *stream, sizeof(VU_ID)*elements);
...
#endif
    memcpy(&interceptor, *stream, sizeof(VU_ID));
    *stream += sizeof(VU_ID);

    if (gCampDataVersion >= 7)
    {
        memcpy(&awacs, *stream, sizeof(VU_ID));
        *stream += sizeof(VU_ID);
        memcpy(&jstar, *stream, sizeof(VU_ID));
        *stream += sizeof(VU_ID);
        memcpy(&ecm, *stream, sizeof(VU_ID));
        *stream += sizeof(VU_ID);
        memcpy(&tanker, *stream, sizeof(VU_ID));
        *stream += sizeof(VU_ID);
    }
    ...
    *stream += sizeof(uchar);
    ...
    if (Final() && !wait_cycles)
    {
        ...
        *stream += sizeof(short);
        ...
        memcpy(&responses, *stream, sizeof(short));
        *stream += sizeof(short);
        memcpy(&mis_request.mission, *stream, sizeof(short));
        *stream += sizeof(short);
        memcpy(&mis_request.context, *stream, sizeof(short));
        *stream += sizeof(short);
        memcpy(&mis_request.requesterID, *stream, sizeof(VU_ID));
        *stream += sizeof(VU_ID);
        memcpy(&mis_request.targetID, *stream, sizeof(VU_ID));
        *stream += sizeof(VU_ID);
#ifdef DEBUG
        ...
        {
            memcpy(&mis_request.tot, *stream, sizeof(CampaignTime));
        ...
        if (gCampDataVersion >= 35)
        {
            memcpy(&mis_request.action_type, *stream, sizeof(uchar));
            *stream += sizeof(uchar);
        }
        else
        {
        ...
        {
            memcpy(&mis_request.priority, *stream, sizeof(short));
            *stream += sizeof(short);
        }
        else
        {
    ...
    else
    {
        ...
        *stream += sizeof(uchar);
        memcpy(&wait_for, *stream, sizeof(short));
        *stream += sizeof(short);
        memcpy(&iax, *stream, sizeof(GridIndex));
        *stream += sizeof(GridIndex);
        memcpy(&iay, *stream, sizeof(GridIndex));
        *stream += sizeof(GridIndex);
        memcpy(&eax, *stream, sizeof(GridIndex));
        *stream += sizeof(GridIndex);
        memcpy(&eay, *stream, sizeof(GridIndex));
        *stream += sizeof(GridIndex);
        memcpy(&bpx, *stream, sizeof(GridIndex));
        *stream += sizeof(GridIndex);
        memcpy(&bpy, *stream, sizeof(GridIndex));
        *stream += sizeof(GridIndex);
        memcpy(&tpx, *stream, sizeof(GridIndex));
        *stream += sizeof(GridIndex);
        memcpy(&tpy, *stream, sizeof(GridIndex));
        *stream += sizeof(GridIndex);
        memcpy(&takeoff, *stream, sizeof(CampaignTime));
        *stream += sizeof(CampaignTime);
        memcpy(&tp_time, *stream, sizeof(CampaignTime));
        *stream += sizeof(CampaignTime);
        memcpy(&package_flags, *stream, sizeof(ulong));
        *stream += sizeof(ulong);
        memcpy(&caps, *stream, sizeof(short));
        *stream += sizeof(short);
        memcpy(&requests, *stream, sizeof(short));
        *stream += sizeof(short);
        ...
        *stream += sizeof(short);
        // Read in routes
        memcpy(&wps, *stream, sizeof(uchar));
        *stream += sizeof(uchar);
        ingress = lw = NULL;
        ...
        *stream += sizeof(uchar);
        ...
        else
        {
            ...
            memcpy(&mis_request, *stream, sizeof(MissionRequestClass));
